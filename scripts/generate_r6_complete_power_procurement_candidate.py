...
OUT = PROJECT / 'teensy-41-can-lin-r6-complete-power.kicad_pcb'
...
add_fp(FP_ROOT/'Package_SO.pretty','SOIC-8_3.9x4.9mm_P1.27mm','U2','MCP2562FD_CAN_A_3V3_IO',94,18,0,{
    '1':'CAN_A_TX','2':'GND','3':'+5V_REGULATED','4':'CAN_A_RX','5':'+3V3','6':'CAN_A_L','7':'CAN_A_H','8':'CAN_A_STB'})
add_fp(FP_ROOT/'Package_SO.pretty','SOIC-8_3.9x4.9mm_P1.27mm','U3','MCP2562FD_CAN_B_3V3_IO',94,39,0,{
    '1':'CAN_B_TX','2':'GND','3':'+5V_REGULATED','4':'CAN_B_RX','5':'+3V3','6':'CAN_B_L','7':'CAN_B_H','8':'CAN_B_STB'})
add_fp(FP_ROOT/'Package_SO.pretty','SOIC-8_3.9x4.9mm_P1.27mm','U4','TLIN1029DRQ1_LIN_3V3_LOGIC',94,64,0,{
    '1':'LIN_RX','2':'LIN_EN','4':'LIN_TX','5':'GND','6':'LIN_BUS','7':'+12V_PROTECTED'})
# TLIN1029 RXD is open-drain; pull it up to Teensy 3.3 V logic.
add_fp(FP_ROOT/'Resistor_SMD.pretty','R_0805_2012Metric_Pad1.20x1.40mm_HandSolder','R1','10k_LIN_RX_PULLUP',86,58,0,{'1':'LIN_RX','2':'+3V3'})
add_fp(FP_ROOT/'Fuse.pretty','Fuse_1206_3216Metric','F1','POLYFUSE_500mA',30,72,0,{'1':'+12V_OBD','2':'+12V_PROTECTED'})
add_fp(FP_ROOT/'Diode_SMD.pretty','D_SMA','D1','SMBJ24CA_TVS_12V',24,80,0,{'1':'+12V_PROTECTED','2':'GND'})
add_fp(FP_ROOT/'Package_TO_SOT_SMD.pretty','TO-263-5_TabPin3','U5','LM2596S-5.0_BUCK',42,88,0,{'1':'+12V_PROTECTED','2':'BUCK_SW','3':'GND','4':'+5V_REGULATED','5':'GND'})
# LM2596 buck regulator required external components and decoupling.
# Fixed 5 V buck topology: VIN -> LM2596 pin1; switch node pin2 -> L1 -> +5V; D2 cathode at switch node, anode to GND.
add_fp(FP_ROOT/'Inductor_THT.pretty','L_Radial_D8.7mm_P5.00mm_Fastron_07HCP','L1','33uH_3A_BUCK_INDUCTOR',58,88,0,{'1':'BUCK_SW','2':'+5V_REGULATED'})
add_fp(FP_ROOT/'Diode_SMD.pretty','D_SMA','D2','SS34_BUCK_SCHOTTKY',56,98,0,{'1':'BUCK_SW','2':'GND'})
add_fp(FP_ROOT/'Capacitor_THT.pretty','CP_Radial_D8.0mm_P3.50mm','C1','100uF_50V_INPUT',18,96,0,{'1':'+12V_PROTECTED','2':'GND'})
add_fp(FP_ROOT/'Capacitor_SMD.pretty','C_0805_2012Metric_Pad1.18x1.45mm_HandSolder','C2','100nF_50V_INPUT',26,88,0,{'1':'+12V_PROTECTED','2':'GND'})
add_fp(FP_ROOT/'Capacitor_THT.pretty','CP_Radial_D8.0mm_P3.50mm','C3','330uF_16V_OUTPUT_LOW_ESR',72,96,0,{'1':'+5V_REGULATED','2':'GND'})
add_fp(FP_ROOT/'Capacitor_SMD.pretty','C_0805_2012Metric_Pad1.18x1.45mm_HandSolder','C4','100nF_16V_OUTPUT',72,84,0,{'1':'+5V_REGULATED','2':'GND'})
# Local transceiver decoupling capacitors.
add_fp(FP_ROOT/'Capacitor_SMD.pretty','C_0805_2012Metric_Pad1.18x1.45mm_HandSolder','C5','100nF_CAN_A_DECOUPLING',86,18,0,{'1':'+5V_REGULATED','2':'GND'})
add_fp(FP_ROOT/'Capacitor_SMD.pretty','C_0805_2012Metric_Pad1.18x1.45mm_HandSolder','C6','100nF_CAN_B_DECOUPLING',86,39,0,{'1':'+5V_REGULATED','2':'GND'})
add_fp(FP_ROOT/'Capacitor_SMD.pretty','C_0805_2012Metric_Pad1.18x1.45mm_HandSolder','C7','100nF_LIN_DECOUPLING',86,64,0,{'1':'+5V_REGULATED','2':'GND'})
...
txt('R6 OBD PIGTAIL + DIP SWITCH CAN/LIN INTERFACE',35,4,1.0,pcbnew.F_SilkS)
...
for ext in ['.kicad_pro','.kicad_prl']:
    ...
    dst=PROJECT/f'teensy-41-can-lin-r6-complete-power{ext}'
